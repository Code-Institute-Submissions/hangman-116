...
![Difficulty Setting](/images/difficulty_setting.PNG)

* Promp user to make a guess

![Guess a letter](/images/guess-a-letter.PNG)
...
![run.py linter check](/images/run_linter_check.PNG)
</details>
...
![run.py linter check](/images/colors_linter_check.PNG)
</details>
...
![run.py linter check](/images/hangman_art_words_linter_check.PNG)
</details>
